...
describe('UCDE-Parameter', () => {
    describe('UCDE-PA-0100-toString', () => {
        describe('UCDE-PA-0101 GIVEN valid inputs WHEN toString() THEN return expected value', () => {
            ...
            ])('UCDE-PA-0101 {direction: $direction, name: $name, type: $type, multiplicity: $multiplicity, defaultValue: $defaultValue, properties: $properties}', ({ direction, name, type, multiplicity, defaultValue, properties, expected }) => {
    ...
    describe('UCDE-PA-0200-validate', () => {
        describe('UCDE-PA-0201 GIVEN valid inputs WHEN validate() THEN no errors returned', () => {
            ...
            ])('UCDE-PA-0201 {name: $name, type: $type, direction: $direction, multiplicity: $multiplicity}', ({ name, type, direction, multiplicity, defaultValue, properties }) => {
                const param = new Parameter(name, type, direction, multiplicity, defaultValue, properties);
        ...
        describe('UCDE-PA-0202 GIVEN invalid name WHEN validate() THEN return expected valid error', () => {
            ...
            ])('UCDE-PA-0202 {name: $name, expectedErrors: $expectedErrors}', ({ name, expectedErrors }) => {
        ...
        describe('UCDE-PA-0204 GIVEN invalid properties WHEN validate() THEN return expected valid error', () => {
            ...
            ])('UCDE-PA-0204 {properties: $properties}', ({ properties, expectedErrors }) => {
                expect(validateStringKeys(expectedErrors)).toBe(true);
        ...
        describe('UCDE-PA-0205 GIVEN invalid default value WHEN validate() THEN return expected valid error', () => {
            ...
            ])('UCDE-PA-0205 {defaultValue: $defaultValue}', ({defaultValue, expectedErrors}) => {
                expect(validateStringKeys(expectedErrors)).toBe(true);
        ...
        describe('UCDE-PA-0206 GIVEN invalid multiplicity WHEN validate() THEN return expected error', () => {
            ...
            ])('UCDE-PA-0206 {multiplicityUpper: $multiplicityUpper}', ({multiplicityUpper, expectedErrors}) => {
                expect(validateStringKeys(expectedErrors)).toBe(true);
