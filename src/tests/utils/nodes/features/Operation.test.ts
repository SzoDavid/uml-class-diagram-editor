            ...
            test.each([
                {
                    ...
                    returnType: 'string',
                    returnMultiplicity: new MultiplicityRange(1),
                    isStatic: false,
                    isAbstract: false,
                    properties: [] as OperationProperty[],
                    redefines: '',
                    expected: '+op1(): string[1]',
                },
                {
                    name: 'op2',
                    params: [new Parameter('param1', 'int')],
                    visibility: null,
                    returnType: 'int',
                    returnMultiplicity: new MultiplicityRange(0),
                    isStatic: true,
                    isAbstract: false,
                    properties: [] as OperationProperty[],
                    redefines: '',
                    expected: 'op2(param1: int): int',
                },
                {
                    name: 'op3',
                    params: [new Parameter('param2', 'string')],
                    visibility: Visibility.PRIVATE,
                    returnType: '',
                    returnMultiplicity: new MultiplicityRange(null),
                    isStatic: false,
                    isAbstract: true,
                    properties: ['unique'] as OperationProperty[],
                    redefines: '',
                    expected: '-op3(param2: string) {abstract, unique}',
                },
                {
                    name: 'op4',
                    params: [new Parameter('param3', 'boolean')],
                    ...
                    properties: [] as OperationProperty[],
                    redefines: '',
                    expected: '#op4(param3: boolean): string[1]',
                },
                {
                    name: 'op5',
                    params: [],
                    ...
                    isStatic: false,
                    isAbstract: false,
                    properties: ['ordered'] as OperationProperty[],
                    redefines: 'var',
                    expected: '~op5(): string {redefines var, ordered}',
                },
            ])(
                'UCDE-O-0101 {name: $name}',
                ({
                    name,
                    params,
                    visibility,
    ...
    describe('UCDE-O-0200-validate', () => {
            ...
            test.each([
                {
                    ...
                    visibility: Visibility.PUBLIC,
                    returnType: 'void',
                    returnMultiplicity: new MultiplicityRange(5),
                    properties: ['unique'] as OperationProperty[],
                },
                {
                    name: 'op2',
                    ...
                    visibility: null,
                    returnType: 'int',
                    returnMultiplicity: new MultiplicityRange('*'),
                    properties: ['ordered'] as OperationProperty[],
                },
            ])(
                'UCDE-O-0201 {name: $name}',
                ({
                    name,
                    params,
                    visibility,
        ...
        describe('UCDE-O-0203 GIVEN invalid return type WHEN validate() THEN return expected valid error', () => {
            test.each([
                ...
                'UCDE-O-0203 {returnType: $returnType}',
                ({ returnType, expectedErrors }) => {
                    expect(validateStringKeys(expectedErrors)).toBe(true);
        ...
        describe('UCDE-O-0204 GIVEN invalid multiplicity WHEN validate() THEN return expected valid error', () => {
            test.each([
                ...
                'UCDE-O-0204 {multiplicityUpper: $multiplicityUpper}',
        ...
        describe('UCDE-O-0205 GIVEN static and abstract true WHEN validate() THEN return expected valid error', () => {
            test.each([
                ...
                'UCDE-O-0205 {isStatic: $isStatic, isAbstract: $isAbstract} ',
                ({ isStatic, isAbstract, expectedErrors }) => {
                    expect(validateStringKeys(expectedErrors)).toBe(true);
            ...
            test.each([
                {
                    params: [
                        new Parameter('', 'int'),
                        new Parameter('param2', 'invalid type!'),
                    ],
                    expectedErrors: [
                        {
                            parameter: 'params',
    ...
    describe('UCDE-O-0400-decorator', () => {
        describe('UCDE-O-0401 GIVEN valid operation WHEN decorator() THEN return the correct type of decoration', () => {
            test.each([
                ...
                'UCDE-O-0401 {isStatic: $isStatic, expectedDecorator: $expectedDecorator}',
    ...
    describe('UCDE-O-0500-prefix', () => {
        describe('UCDE-O-0501 GIVEN valid operation WHEN prefix() THEN return the expected value', () => {
            test.each([
                ...
                'UCDE-O-0501 {visibility: $visibility, omitVisibility: $omitVisibility}',
                ({ visibility, omitVisibility, expected }) => {
    ...
    describe('UCDE-O-0600-toMultilineString', () => {
        describe('UCDE-O-0601 GIVEN valid operation WHEN toMultilineString() THEN return expected value', () => {
            test.each([
                ...
                'UCDE-O-0601 {name: $name}',
                ({ name, params, returnType, expected }) => {
                    const operation = new Operation(
                        name,
                        params,
                        undefined,
