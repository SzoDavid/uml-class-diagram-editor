...
describe('UCDE-Property', () => {
    describe('UCDE-PR-0100-toString', () => {
        describe('UCDE-PR-0101 GIVEN valid inputs WHEN toString() THEN return expected value', () => {
            ...
            ])('UCDE-PR-0101 {name: $name, type: $type, visibility: $visibility, modifiers: $modifiers}', ({ name, type, visibility, isDerived, multiplicity, defaultValue, isStatic, modifiers, redefines, subsets, expected }) => {
    ...
    describe('UCDE-PR-0200-validate', () => {
        ...
        describe('UCDE-PR-0202 GIVEN invalid name WHEN validate() THEN return expected valid error', () => {
            ...
            ])('UCDE-PR-0202 {name: $name, expectedErrors: $expectedErrors}', ({ name, expectedErrors }) => {
        ...
        describe('UCDE-PR-0204 GIVEN invalid defaultValue WHEN validate() THEN return expected valid error', () => {
            ...
            ])('UCDE-PR-0204 {defaultValue: $defaultValue}', ({defaultValue, expectedErrors}) => {
                expect(validateStringKeys(expectedErrors)).toBe(true);
        ...
        describe('UCDE-PR-0205 GIVEN invalid multiplicity WHEN validate() THEN return expected error', () => {
            ...
            ])('UCDE-PR-0205 {multiplicityUpper: $multiplicityUpper}', ({multiplicityUpper, expectedErrors}) => {
                expect(validateStringKeys(expectedErrors)).toBe(true);
    ...
    describe('UCDE-PR-0300-clone', () => {
        describe('UCDE-PR-0301 GIVEN valid property WHEN clone() THEN return new instance with same values', () => {
            ...
            ])('UCDE-PR-0300 {name: $name, type: $type}', ({ name, type, visibility, multiplicity, defaultValue, isStatic, modifiers }) => {
    ...
    describe('UCDE-PR-0400-decorator', () => {
        describe('UCDE-PR-0401 GIVEN valid property WHEN decorator() THEN return the correct type of decoration', () => {
            ...
            ])('UCDE-PR-0401 {isStatic: $isStatic, expectedDecorator: $expectedDecorator}', ({ isStatic, expectedDecorator }) => {
    ...
    describe('UCDE-PR-0500-prefix', () => {
        describe('UCDE-PR-0501 GIVEN valid property WHEN prefix() THEN return the expected value', () => {
            ...
            ])('UCDE-PR-0501 {visibility: $visibility, isDerived: $isDerived, omitVisibility: $omitVisibility}', ({visibility, isDerived, omitVisibility, expected}) => {
