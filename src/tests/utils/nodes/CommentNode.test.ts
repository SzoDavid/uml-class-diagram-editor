...
describe('UCDE-CommentNode', () => {
    ...
    describe('UCDE-CN-0100-Constructor', () => {
        test('UCDE-CN-0101 GIVEN valid inputs WHEN creating CommentNode THEN properties should be set correctly', () => {
    ...
    describe('UCDE-CN-0200-clone', () => {
        test('UCDE-CN-0201 GIVEN valid CommentNode WHEN clone() THEN return a new instance with same values', () => {
    ...
    describe('UCDE-CN-0300-copy', () => {
        test('UCDE-CN-0301 GIVEN another CommentNode WHEN copy() THEN copy values correctly', () => {
    ...
    describe('UCDE-CN-0400-validate', () => {
        test('UCDE-CN-0401 GIVEN valid CommentNode WHEN validate() THEN no validation error should be returned', () => {
            expect(commentNode.validate()).toHaveLength(0);
        });

        describe('UCDE-CN-0402 GIVEN invalid name WHEN validate() THEN expected valid error should be returned', () => {
            test.each([
                { text: '', expectedErrors: [{parameter: 'text', message: 'error.comment_empty' }]},
            ])('UCDE-CN-0402 {text: $text}', ({ text, expectedErrors }) => {
